...
class Login_Gui(Tk):
    def __init__(self):
        ...
        self.logo = PhotoImage(file = r"D:\Coding\Library System\Library_Management_System\Assets\logo.png") 
        ...
        self.login_button = Button(text = "Login", width = 15, bg = "#28a745", fg = "white", highlightthickness = 0, command = self.handle_login)
        self.login_button.grid(column = 1, row = 5, pady = 10)
        self.signup_button = Button(text = "Signup", width = 15, bg = "#007bff", fg = "white", highlightthickness = 0, command=self.handel_signup)
